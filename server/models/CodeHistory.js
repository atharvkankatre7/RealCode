...
codeHistorySchema.index({ userId: 1, updatedAt: -1 });
// Text index for quick search across fields with language detection completely disabled
codeHistorySchema.index(
